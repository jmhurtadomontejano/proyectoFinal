...
<div class="body d-flex align-items-center justify-content-center bg-br-primary ht-100v">
        ...
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
            ...
            <form id="login" action="login" method="post">
                ...
                <section class="d-flex justify-content-evenly flex-wrap">
                    <input type="submit" value="Login" id="btnlogin" class="btn btn-primary" style="padding:10px">
            ...
            <div class="mg-t-60 tx-center">¿Todavía no esta registrado? <a href="register.php"
                    class="tx-info">Registrarse Redes</a></div>
    ...
    <section class="d-flex justify-content-around flex-wrap">
        ...
        <?php if (Session::existe()) { ?>
        <button type="button"
            class="d-flex btn btnIndex btn-secondary col-md-3 col-12 d-flex align-items-center justify-content-center"
            style="margin:10px">
        ...
        <button type="button" class="btn btnIndex btn-info col-md-3 col-12" style="margin:10px">
            <a class="nav-link" style="color:white; font-size:2em" href="<?= RUTA?>own_itemsDaylyAdmins">Mis Items
                Diarios
                <i class="fa-solid fa-list-check"></i></a>
        </button>
        <button type="button" class="btn btnIndex btn-info col-md-3 col-12" style="margin:10px">
            <a class="nav-link" style="color:white; font-size:2em" href="<?= RUTA?>own_itemsUsers">Mis Items Cliente
                <i class="fa-solid fa-list-check"></i></a>
        </button>
