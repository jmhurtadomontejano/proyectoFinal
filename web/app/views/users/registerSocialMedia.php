...
<body>
    ...
    <div class="d-flex align-items-center justify-content-center bg-br-primary ht-100v">
        ...
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white rounded shadow-base">
            <div class="signin-logo tx-center tx-28 tx-bold tx-inverse"><span class="tx-normal">[</span> Registrate
                <span class="tx-normal">]</span>
            </div>
            <div class="tx-center mg-b-60">Ingrese usuario y contraseña</div>

            <div class="form-group">
                <input type="text" id="usu_nom" name="usu_nom" class="form-control"
            ...
            <div class="form-group">
                <input type="password" id="usu_pass1" name="usu_pass1" class="form-control"
