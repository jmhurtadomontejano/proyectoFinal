        ...
        <form class="form-floating" action="" method="post" enctype="multipart/form-data">
            <fieldset class="form" style="border-radius: 35px">
                <div class="row" style="paddin:10px; margin:10px">
                    ...
                    <div class="form-group col-md-6 col-12 m-10">
                    ...
                    <div class="form-group col-md-6 col-7">
                        ...
                        <div id="postalCodeHelp" class="form-text">
                            <small>Selecciona Codigo Postal</small>
                        </div>
                    </div>
                    <div class="form-group col-md-6 col-12">
                    ...
                    <div class="form-group col-md-6 col-12">
                        ...
                        <input type="password" name="password2" id="password2" class="form-control"
                            placeholder="Introduce aqui tu password">
                            <div id="password2Help" class="form-text">Escribe la misma contraseña que en la casilla anterior, exactamente igual que antes.
                </div>
                    </div>
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="datesConsent" name="datesConsent"
                            checked>
                        <label class=" form-label" for="flexCheckChecked">Doy mi Consentimiento según Ley de
                            Protección de Datos
                        </label>
                    </div>
                    <div class="btn-confirm-form" style="justify-content:center; align-items:center padding-top:2em">
                        <button type="submit" value="registrar" class="btn-title col-12"
                            style="margin-top:2em">Registrar Usuario</button>
                    </div>
                </div>
        </form>
    </div>
